...
export const RevenueDetails = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="text-2xl font-bold mb-4">Weekly Performance</h3>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div>
          <h3 className="text-2xl font-bold mb-4">Upcoming Opportunities</h3>
      ...
      {/* Client Summary */}
      <div>
        <h3 className="text-2xl font-bold mb-4">Top Clients</h3>
